...
namespace Board.BusinessLogic.ViewModels.SQLiteConfig
{
    public class SQLiteConfigWindowViewModel : BaseViewModel
    {
        ...
        public SQLiteConfigWindowViewModel(ISQLiteConfigWindowAccess access, IDialogService dialogService, SQLiteConfigResult data)
        {
            ...
            pathExistsCondition = new ChainedLambdaCondition<SQLiteConfigWindowViewModel>(this, vm => System.IO.File.Exists(vm.Path), false);
            ...
            fileAlreadyExistsCondition = new ChainedLambdaCondition<SQLiteConfigWindowViewModel>(this, vm => System.IO.File.Exists(vm.Path + vm.WallName), false);
